...
namespace Unity.Netcode.Editor
{
    ...
    public class NetworkTransformEditor : UnityEditor.Editor
    {
        ...
        private SerializedProperty m_SyncParentProperty;
        ...
        public void OnEnable()
        {
            ...
            m_SyncParentProperty = serializedObject.FindProperty(nameof(NetworkTransform.SyncParent));
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_SyncParentProperty);
